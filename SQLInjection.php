...
//
//    }
// HÄR NEDAN ÄR VÅR SERVER, SKA UPPDATERAS TILL MATILDA!!!
...
if (isset($_POST['username'], $_POST['userpass'])) {
    ...
    // hÄR ÄNDRAR VI TILL VÅRA DB NAMN I TABELLEN, Den nedan är grå för att man inte ska se koden i webbläsaren om användare och lösen/scrambled kod
    
    // echo "SELECT * FROM User WHERE UserName = '{$uname}' AND UserPassword = '{$upass}'";
    
    $query = ("SELECT * FROM User WHERE UserName = '{$uname}' "."AND UserPassword = '{$upass}'");
