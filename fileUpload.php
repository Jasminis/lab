    ...
    <head>
        <title>Security - Upload</title>
           ...
           <body>
               <div>
                   ...
                   if (isset($error)){
                       if (empty($error)){
                        ...
                        // ÄNRA FILNAMNET "FILES"

                           echo '<a href="Files/' . $_FILES['upload']['name'] . '">Check file';
               ...
               <!-- Nedan kod är till för att visa bilderna i "galleriet" som man har laddat upp -->
               <?php 
               $dirname = "Files/";
                  $images = glob($dirname."*");
